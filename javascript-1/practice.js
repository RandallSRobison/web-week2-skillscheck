...
const doubled = myNumbers.map(function(item) {
  return item * 2;
});
console.log(doubled);
...
// Code Here
const filtered = myNumbers.filter(item => {
  if (item > 100) {
    return true;
  } else {
    return false;
...
// Code Here
const total = myNumbers.reduce((accumulator, currentValue) => accumulator += currentValue)
console.log(total);
//////////////////PROBLEM 17////////////////////
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map(function (item) {
	return item = "George"
})
